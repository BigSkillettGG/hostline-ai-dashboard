...
export const calls: Call[] = [
  {
    ...
    transcript: [
      { speaker: "agent", t: "00:00", text: "Thanks for calling Olive & Ember, this is Vera. How can I help you?" },
  ...
  },
  {
    ...
    transcript: [
      { speaker: "agent", t: "00:00", text: "Olive & Ember, this is Vera. How can I help you?" },
...
export const knowledgeSections = [
  ...
  { id: "parking", title: "Parking", body: "Metered street parking on Valencia. Paid lot at 17th & Valencia.", uses: 41 },
  { id: "pickup", title: "Pickup policy", body: "Pickup orders are pay-at-pickup. Typical wait 20–30 minutes during peak.", uses: 67 },
  { id: "delivery", title: "Delivery policy", body: "We do not offer direct delivery. Available via DoorDash and Uber Eats.", uses: 33 },
  { id: "allergy", title: "Allergy policy", body: "We accommodate gluten-free and dairy-free where possible. Cross-contact possible — please disclose severe allergies.", uses: 22 },
...
export const integrations = [
  { id: "toast", name: "Toast", desc: "Sync orders into your Toast POS.", status: "connected" as const, category: "POS" },
  { id: "square", name: "Square", desc: "Send orders to Square register.", status: "not_connected" as const, category: "POS" },
  { id: "clover", name: "Clover", desc: "Push orders to Clover.", status: "not_connected" as const, category: "POS" },
  { id: "opentable", name: "OpenTable", desc: "Book reservations into OpenTable.", status: "connected" as const, category: "Reservations" },
  { id: "resy", name: "Resy", desc: "Sync reservations with Resy.", status: "needs_attention" as const, category: "Reservations" },
  { id: "tock", name: "Tock", desc: "Send bookings to Tock.", status: "not_connected" as const, category: "Reservations" },
  { id: "sevenrooms", name: "SevenRooms", desc: "Guest profiles and reservations.", status: "not_connected" as const, category: "Reservations" },
  { id: "yelp", name: "Yelp Guest Manager", desc: "Sync waitlist and reservations.", status: "not_connected" as const, category: "Reservations" },
  { id: "printer", name: "Receipt Printer", desc: "Auto-print order tickets.", status: "connected" as const, category: "Hardware" },
  { id: "kds", name: "Kitchen Tablet", desc: "Display orders on kitchen display.", status: "needs_attention" as const, category: "Hardware" },
];
