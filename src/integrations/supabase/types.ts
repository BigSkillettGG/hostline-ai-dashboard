  ...
  public: {
    Tables: {
      ...
      business_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "business_links_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
      ...
      message_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "message_events_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      can_access_queue: { Args: { target_queue_id: string }; Returns: boolean }
      ...
      can_operate_queue: { Args: { target_queue_id: string }; Returns: boolean }
