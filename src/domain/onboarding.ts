  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: "Thanks for calling {restaurant_name}. This is Vera, the restaurant's virtual host. How can I help you?",
        control: "long",
        required: true,
      },
      {
...
export const sampleOnboardingDraft: OnboardingDraft = {
  ...
  greeting: "Thanks for calling {restaurant_name}. This is Vera, the restaurant's virtual host. How can I help you?",
  hostName: "Vera",
