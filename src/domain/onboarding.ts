  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: "Hi, thanks for calling {restaurant_name}. This is Vera. How can I help you today?",
        control: "long",
        required: true,
      },
      {
...
export const sampleOnboardingDraft: OnboardingDraft = {
  ...
  greeting: "Hi, thanks for calling {restaurant_name}. This is Vera. How can I help you today?",
  hostName: "Vera",
