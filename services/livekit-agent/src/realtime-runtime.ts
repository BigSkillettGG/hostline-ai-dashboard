...
export function buildLiveKitRealtimeInstructions(
  ...
  return [
    ...
    "Never invent a room, service, menu item, address, urgency, date, time, party size, or symptom that the caller did not clearly say. If a detail matters and was not clearly spoken, ask for it.",
