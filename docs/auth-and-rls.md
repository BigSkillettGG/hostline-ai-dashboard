...
The current commercial hierarchy migration is `20260806010000_commercial_hierarchy_foundation.sql`. Applying it is a separate production database operation and must be verified through a database-capable deployment path.
